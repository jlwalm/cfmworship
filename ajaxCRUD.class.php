...
class ajaxCRUD{
    ...
    function insertHeader($ajax_file){
		...
		#echo "<script src=\"" . $this->ajaxcrud_root . "/lightwindow/javascript/prototype.js\" type=\"text/javascript\"></script>\n";
		#echo "<script src=\"" . $this->ajaxcrud_root . "/lightwindow/javascript/scriptaculous.js?load=effects\" type=\"text/javascript\"></script>\n";
		#echo "<script src=\"" . $this->ajaxcrud_root . "/lightwindow/javascript/lightwindow.js\" type=\"text/javascript\"></script>\n";
        #echo "<link href=\"" . $this->ajaxcrud_root . "lightwindow/css/lightwindow.css\" rel=\"stylesheet\" type=\"text/css\" media=\"screen\" />\n";
	...
	function showTable(){
        ...
        */
        ...
        if ($row_count > 0){
            ...
            $table_html .= "<table align='center' class='table table-striped table-bordered table-condensed table-hover' name='table_" . $this->db_table . "' id='table_" . $this->db_table . "' cellspacing='" . $this->cellspacing . "' border=" . $this->border . ">\n";
            $table_html .= "<tr>\n";
                    ...
                    if ( ($this->fieldInArray($field, $this->uneditable_fields) && (!is_numeric($found_category_index))) || !$this->ajax_editing){
                        ...
                        if ($this->fieldInArray($field, $this->file_uploads)){
                            ...
                            if ($cell_data != ''){
                                ...
                                $table_html .= "<span id='text_" . $field . $id . "'><a target=\"_new\" href=\"$file_link\">" . $cell_data . "</a> <a class='hide' style=\"font-size: 9px;\" href=\"javascript:\" onClick=\"document.getElementById('file_$field$id').style.display = ''; document.getElementById('text_$field$id').style.display = 'none'; \">edit</a> <a class='hide' style=\"font-size: 9px;\" href=\"javascript:\" onClick=\"deleteFile('$field', '$id')\">delete</a></span>\n";
