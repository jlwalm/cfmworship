...
?>
   ...
   <?php
    ...
    $tblDemo = new ajaxCRUD("Item", "songs", "idsongs", "");

    ##
    ########################################################
    $tblDemo->setCSSFile('bluedream.css');

    $tblDemo->displayAs("idsongs", "Song ID");
    $tblDemo->displayAs("song_name", "Song Name");
...
$tblDemo->disallowEdit('filename');

$tblDemo->disallowEdit('chords');
...
$tblDemo->addButtonToRowWindowOpen = "new";
$tblDemo->addButtonToRow("Chords", "resources_edit.php", "idsongs");
$tblDemo->omitFieldCompletely('filename');
    #i can order my table by whatever i want
    $tblDemo->addOrderBy("ORDER BY song_name ASC");

$tblDemo->omitFieldCompletely('flag');
   ...
   # function chordlink($val){
    ...
    #return "<a href='chords/$val'target='_blank' class='bump'>Chords</a>";
