...
$new_location = $_REQUEST["destination"];
$cleanpw = md5($urlpw);
...
setcookie($cookie_name,$cookie_value,false,"/","www.cfmworship.org.uk");
...
echo '<META HTTP-EQUIV="Refresh" Content="0; URL='. $failed_login .'">'; 
}
